...
Generated by 'django-admin startproject' using Django 2.2.dev20181118002753.
...
SECRET_KEY = 'uli=+j_axt@m&u&z96v4dj3yz=@rfbzfhdmto0jb5m03v62qhi'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'uploader/static')
